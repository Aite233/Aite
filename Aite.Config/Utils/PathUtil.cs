...
namespace Aite.Config.Utils;

public static class PathUtil {
    public static readonly string CachePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "cache");

    //public static readonly string CachePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "resources");
    ...
    public static readonly string CustomModsPath = Path.Combine(CachePath, "mods");
    ...
    // public static readonly string WebSitePath = Path.Combine(CachePath, "static");
    ...
    private static string GetJavaExePath()
    {
        ...
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows)) {
            return AiteConfig.Config.UseJavaW ? "javaw.exe" : "java.exe";
        }
        return "java";
    }
