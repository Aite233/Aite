...
public class EntityAccount : EntityUserInfo {
    ...
    {
        return AiteConfig.Config.AutoLoginGame && (
            ("163Email".Equals(Type) && AiteConfig.Config.AutoLoginGame163Email) || 
            ("cookie".Equals(Type) && AiteConfig.Config.AutoLoginGameCookie));
    }
